...
def main():
    ...
    st.write('<img src="https://www.google-analytics.com/collect?v=1&tid=UA-18433914-1&aip=1&t=event&ec=coronavirus_viz&ea=coronavirus_viz">',unsafe_allow_html=True)
    ...
    if len(option) > 0:
        st.write('<img src="https://www.google-analytics.com/collect?v=1&tid=UA-18433914-1&aip=1&t=event&ec=coronavirus_viz&ea='+option+'">',unsafe_allow_html=True)
        state=option
